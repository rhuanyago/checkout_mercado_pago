<form id="form-checkout" x-show="$wire.method == 1">
    <div class="grid grid-cols-6 py-4 gap-x-4 gap-y-6 sm:grid-cols-8">
        <div class="col-span-4 sm:col-span-8">
            ...
            <div class="mt-1">
                <div class="block w-full h-10 border-gray-300 rounded-md shadow-sm text-primary-200 bg-tertiary-800 focus:border-primary-200 focus:ring-primary-200 sm:text-sm"
        ...
        <div class="col-span-4 sm:col-span-6">
            ...
            <div class="mt-1">
                <x-text-input type="text" id="form-checkout__identificationNumber" name="card_holder_name"
                    placeholder="Nome igual escrito no cartão" wire:model='user.cpf' />
